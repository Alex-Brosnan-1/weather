...
const Card = ({time, temp, precipitation, humidity, weatherCode} : {time: string, temp: string, precipitation: string, humidity: number, weatherCode: number}) => {
    return (
        <StyledWrapper>
            <div className="cardContainer">
                <div className="card">
                    <p className="city">{time}</p>
                    <p className="weather">{WEATHER_CODE_MAP[weatherCode] ?? "Unknown weather condition"}</p>
                    ...
                    <div className="minmaxContainer">
                        <div className="min">
                            <p className="minHeading">Precipitation</p>
                            <p className="minTemp">{precipitation}%</p>
                        </div>
                        <div className="max">
                            <p className="maxHeading">Humidity</p>
                            <p className="maxTemp">{humidity}%</p>
                        </div>
                    </div>
                </div>
            </div>
